...
function resolveChartKindName(chartKind: ChartKind): string {
  switch(chartKind) {
    case ChartKind.Revenue: return 'Выручка';
    case ChartKind.Cost: return 'Себестоимость';
    case ChartKind.Margin: return 'Маржа';
    case ChartKind.K1: return 'K1';
    case ChartKind.K2: return 'K2';
    ...
    <ResponsiveContainer width="100%" height="56%">
      <BarChart
        ...
        >
          ...
          <XAxis dataKey="name" height={60} allowDataOverflow={true} angle={90} interval={0} tick={<CustomizedAxisTick />}/>
          <YAxis />
          <Tooltip />
